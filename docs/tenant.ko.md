...
| 사용 사례 | 다음 단계 |
|-------------|---------|
| Shelby 테스트넷 RPC 및 스토리지 노드 | [DoubleZero Testnet 연결](Shelby%20Permissioned%20Connection.md) |

새 테넌트

| 사용 사례 | 다음 단계 |
-------------|---------|
| DoubleZero를 활용할 새 프로토콜, 애플리케이션 또는 기타 사용 사례가 있습니다 | [새 테넌트 추가](New%20Tenant.md) |
