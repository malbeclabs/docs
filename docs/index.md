...
* *For Users* Learn how to perform [initial setup](setup.md), connect to DoubleZero in [IBRL mode](DZ%20Mainnet-beta%20Connection.md), and in [multicast mode](Multicast%20Connection.md) to start using the network.
