...
| --- | --- | --- | --- |
| **Market Data Feeds (Edge)** | Top-of-Book y Market-by-Order como UDP multicast en DoubleZero Edge. | Traders | [Suscribirse a Hyperliquid (Edge)](edge.md) |
| **Peering** | Un feed de gossip de Hyperliquid deduplicado a través de Block Proxy (sin datos de mercado). | Nodos no validadores | [Acceso de Peering](peering.md) |
...
Cómo conectarse: [Acceso de Peering](peering.md).