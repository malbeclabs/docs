...
Para mais detalhes, consulte o whitepaper do [Protocolo DoubleZero](https://doublezero.xyz/whitepaper.pdf).


## Próximos Passos

* *Para Usuários* - Comece com nosso [Assistente de Conexão Rápida](quick-connect.md) para criar um guia de configuração personalizado com base no tipo de usuário, ou vá direto para a [configuração inicial](setup.md) e siga o fluxo de configuração manualmente.
