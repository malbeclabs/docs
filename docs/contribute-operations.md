...
- `doublezero_agent_apply_config_errors_total` - The configuration attempting to be applied by the agent failed. In this situation, users will not be able to onboard to the device and onchain configuration changes will not be applied until this is resolved.
