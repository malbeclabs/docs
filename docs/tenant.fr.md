---
description: Choisissez le tenant DoubleZero et le chemin de connexion qui correspond à votre cas d'utilisation — validateurs Solana, RPCs, données de marché Kalshi, Shelby ou un nouveau protocole.
---
...
| Cas d'utilisation | Étape suivante |
-------------|---------|
| Vous avez un nouveau protocole, une nouvelle application ou un autre cas d'utilisation pour tirer parti de DoubleZero | [Ajouter un nouveau tenant](New%20Tenant.md) |