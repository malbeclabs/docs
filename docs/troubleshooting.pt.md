...
5. Conecte ao Dispositivo DoubleZero mais próximo
    ...
    ✅  User Provisioned
    ```
    observe na saída acima que nos `Connected to device: dz-ny7-sw01` este é o resultado desejado da nossa investigação inicial no passo 1, onde descobrimos que `dz-ny7-sw01` era o dispositivo com a menor latência.
