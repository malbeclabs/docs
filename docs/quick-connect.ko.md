...
<span class="wizard-card-desc">Rocky Linux 또는 RHEL 9+</span>
</button>
</div>
</div>
...
<span class="wizard-card-desc">Shelby의 RPC 및 스토리지 노드 (Testnet 전용)</span>
</button>
...
<span class="wizard-card-desc">유니캐스트와 멀티캐스트 터널 동시 사용</span>
</button>
</div>
</div>
