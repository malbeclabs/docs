...
# Edge Subscriber Connection (CLI)

!!! warning "Legacy CLI subscription — decommissioned **August 30, 2026**"
    This page is for users already on the **CLI / onchain seat** subscription (`doublezero-solana shreds pay`). That system is being decommissioned on **August 30, 2026**.

    New subscriptions use the portal flow on [Subscribe to shreds (Edge)](Edge Subscriber Connection.md).
